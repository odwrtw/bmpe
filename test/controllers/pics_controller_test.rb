...
class PicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pic" do
    assert_difference('Pic.count') do
      post pics_url, params: { pic: { camera_id: @pic.camera_id, filename: @pic.filename, validated: @pic.validated } }
    end
  ...
  test "should update pic" do
    patch pic_url(@pic), params: { pic: { camera_id: @pic.camera_id, filename: @pic.filename, validated: @pic.validated } }
